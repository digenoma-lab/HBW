...
uk15_A=open(u"/Users/cvalenzuela/GIT/HBW/dataset/simulated_data/trio_data/unique-mers/uk15/hapA_only_kmers.txt","r")
uk15_A=uk15_A.readlines()
uk15_A=(map(parser,uk15_A))
print(uk15_A[0:5])

uk15_B=open(u"/Users/cvalenzuela/GIT/HBW/dataset/simulated_data/trio_data/unique-mers/uk15/hapB_only_kmers.txt","r")
...
with gzip.open(u"/Users/cvalenzuela/GIT/HBW/dataset/simulated_data/trio_data/long-reads/kidONT.R94.30X.p1.fasta.gz", "rt") as handle:
