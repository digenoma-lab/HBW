...
${PREF}-sv-asm-dip/variants.vcf: ${PREF}.aln.hap2.sorted.bam
	...
	${BIN}/svim-asm diploid ${PREF}-sv-asm-dip ${PREF}.aln.hap1.sorted.bam ${PREF}.aln.hap2.sorted.bam ${REF} \
	 --min_sv_size 20 --tandem_duplications_as_insertions --interspersed_duplications_as_insertions --reference_gap_tolerance 1000 \
	 --reference_overlap_tolerance 1000 --query_gap_tolerance 2000 --query_overlap_tolerance 2000 --max_edit_distance 200 \
...
${PREF}-sv-asm-hap/variants.vcf: ${PREF}.aln.hap2.sorted.bam
	...
	${BIN}/svim-asm haploid ${PREF}-sv-asm-hap ${PREF}.aln.hap1.sorted.bam ${REF} \
	 --min_sv_size 20 --tandem_duplications_as_insertions --interspersed_duplications_as_insertions --reference_gap_tolerance 1000 \
	 --reference_overlap_tolerance 1000 --query_gap_tolerance 2000 --query_overlap_tolerance 2000 \
	 --sample HG002 --query_names
